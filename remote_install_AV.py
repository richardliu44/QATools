...
DEFAULT_PASSWORD = "defalt_password"
AV_PASSWORD = "AV_PASSWORD"

def script_usage():
    print("Usage: install_av_remote.py -s Avamar_Server_IP -v Avamar_Server_Version,eg.19.4.0.100")
...
def support_key():
    if re.match('73[0-1]', opt_arg()[0]):
        supportkey = 'YOUR_SUPPORTKEY1'
    elif re.match('74[0-1]', opt_arg()[0]):
        supportkey = 'YOUR_SUPPORTKEY2'
    elif re.match('75[0-1]', opt_arg()[0]):
        supportkey = 'YOUR_SUPPORTKEY3'
    elif re.match('18[1-2]0', opt_arg()[0]):
        supportkey = 'YOUR_SUPPORTKEY4'
    elif re.match('19[1-5]0', opt_arg()[0]):
        supportkey = 'YOUR_SUPPORTKEY5'
    return supportkey
